...
public class SigmaCapriWSServiceLocator extends org.apache.axis.client.Service implements umsa.capricornio.gui.ConnectSigma.SigmaCapriWSService {
    ...
    public umsa.capricornio.gui.ConnectSigma.SigmaCapriWS_PortType getSigmaCapriWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            umsa.capricornio.gui.ConnectSigma.SigmaCapriWSSoapBindingStub _stub = new umsa.capricornio.gui.ConnectSigma.SigmaCapriWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (umsa.capricornio.gui.ConnectSigma.SigmaCapriWS_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                umsa.capricornio.gui.ConnectSigma.SigmaCapriWSSoapBindingStub _stub = new umsa.capricornio.gui.ConnectSigma.SigmaCapriWSSoapBindingStub(new java.net.URL(SigmaCapriWS_address), this);
                _stub.setPortName(getSigmaCapriWSWSDDServiceName());
                return _stub;
            }
        }
