...
public class SigmaCapriWSServiceLocator extends org.apache.axis.client.Service implements umsa.capricornio.gui.ConnecSigma.SigmaCapriWSService {
    ...
    public umsa.capricornio.gui.ConnecSigma.SigmaCapriWS_PortType getSigmaCapriWS() throws javax.xml.rpc.ServiceException {
    ...
    public umsa.capricornio.gui.ConnecSigma.SigmaCapriWS_PortType getSigmaCapriWS(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            umsa.capricornio.gui.ConnecSigma.SigmaCapriWSSoapBindingStub _stub = new umsa.capricornio.gui.ConnecSigma.SigmaCapriWSSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (umsa.capricornio.gui.ConnecSigma.SigmaCapriWS_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                umsa.capricornio.gui.ConnecSigma.SigmaCapriWSSoapBindingStub _stub = new umsa.capricornio.gui.ConnecSigma.SigmaCapriWSSoapBindingStub(new java.net.URL(SigmaCapriWS_address), this);
                _stub.setPortName(getSigmaCapriWSWSDDServiceName());
                return _stub;
            }
        }
