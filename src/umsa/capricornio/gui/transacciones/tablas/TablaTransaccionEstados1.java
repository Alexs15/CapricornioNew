...
import umsa.capricornio.domain.TransaccionEstadosData1;
 ...
 * @author julian
 */
public class TablaTransaccionEstados1 extends AbstractTableModel 
{
  ...
  public TablaTransaccionEstados1() {    
    //m_vector = new Vector();
      lista = new ArrayList();
  }
  ...
  public Object getValueAt(int nRow, int nCol) {
    ...
    TransaccionEstadosData1 row = (TransaccionEstadosData1)lista.get(nRow);
    switch (nCol) {
  ...
  public void insert(int row) {
    ...
    lista.add(row,new TransaccionEstadosData1());
  }
