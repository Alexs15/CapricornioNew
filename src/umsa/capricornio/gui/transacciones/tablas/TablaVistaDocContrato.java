...
import umsa.capricornio.domain.Doc;
 ...
 * @author UMSA-JES
 */
public class TablaVistaDocContrato extends AbstractTableModel 
{
  static final public ColumnData m_columns[] = {
    new ColumnData( "Descripcion", 15, JLabel.CENTER ),
    new ColumnData( "Fecha", 15, JLabel.CENTER ),  
...
//    new ColumnData( "Monto", 10, JLabel.RIGHT )   
  ...
  public Object getValueAt(int nRow, int nCol) {
    if (nRow < 0 || nRow>=getRowCount())
      return "";
    Doc row = (Doc)lista.get(nRow);
    switch (nCol) {
      case 0: return row.descripcion;
      case 1: return row.fecha;
