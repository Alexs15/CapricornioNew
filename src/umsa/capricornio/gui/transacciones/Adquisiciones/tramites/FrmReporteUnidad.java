...
public class FrmReporteUnidad extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TODO", "SOLO ORDENES", "SOLO RESOLUCIONES" }));
    ...
    private void BtnReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnReporteActionPerformed
        ...
        else
        {
            if(cod_rol==5 || cod_rol==2)
            {
                ...
                this.genera_res_15.ReporteSimplificado(fi, ff,cod_user,cod_rol,x2,dm1,dm2);
            }
            if(cod_rol==4)
            {
                fi=(Date) DatFec_ini.getValue();
