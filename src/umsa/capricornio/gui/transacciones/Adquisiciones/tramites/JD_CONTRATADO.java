...
public class JD_CONTRATADO extends javax.swing.JDialog {
    ...
    private void CargaContratado(int cod_transaccion){
        try {
            ...
            Map[] datos = puerto.getContratoContratado(cod_transaccion);
            if (datos != null) {
...
//                System.err.println("Con Datos");
                ...
                this.JTF_PROVINCIA_CONTRATADO.setText(datos[0].get("DENO_PROVINCIA_ADJUDICADO").toString());
                this.JTF_DEPARTAMENTO_CONTRATADO.setText(datos[0].get("DENO_DEPARTAMENTO_ADJUDICADO").toString());
    ...
    private void GuardaContratado(int cod_transaccion){
        try {
            ...
            Map[] datos = puerto.updateContratoContratado(cod_transaccion
                    ,this.JTF_NOMBRE_CONTRATADO.getText()
                    ,this.JTF_NEMPRESA_CONTRATADO.getText()
                    ,this.JTF_DIRECCION_CONTRATADO.getText()
                    ,this.JTF_CI_CONTRATADO.getText()
                    ,this.JTF_DENOMINACION_CONTRATADO.getText()
                    ,this.JTF_PROVINCIA_CONTRATADO.getText()
                    ,this.JTF_DEPARTAMENTO_CONTRATADO.getText()
            );
...
//                System.err.println("Vacio!!!");
    ...
    private void initComponents() {
        ...
        JTF_PROVINCIA_CONTRATADO = new javax.swing.JTextField();
        ...
        JTF_DEPARTAMENTO_CONTRATADO = new javax.swing.JTextField();
        ...
        JTF_PROVINCIA_CONTRATADO.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JTF_PROVINCIA_CONTRATADOActionPerformed(evt);
            }
        });
        ...
        JTF_DEPARTAMENTO_CONTRATADO.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JTF_DEPARTAMENTO_CONTRATADOActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(JTF_NOMBRE_CONTRATADO, javax.swing.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
                        .addComponent(JTF_NEMPRESA_CONTRATADO)
                        .addComponent(JTF_CI_CONTRATADO)
                        .addComponent(JTF_DIRECCION_CONTRATADO)
                        .addComponent(JTF_DENOMINACION_CONTRATADO)
                        .addComponent(JTF_PROVINCIA_CONTRATADO)
                        .addComponent(JTF_DEPARTAMENTO_CONTRATADO)))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel6)
                    .addComponent(JTF_PROVINCIA_CONTRATADO, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
                    .addComponent(JTF_DEPARTAMENTO_CONTRATADO, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void JTF_PROVINCIA_CONTRATADOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JTF_PROVINCIA_CONTRATADOActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JTF_PROVINCIA_CONTRATADOActionPerformed
    ...
    private void JTF_DEPARTAMENTO_CONTRATADOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JTF_DEPARTAMENTO_CONTRATADOActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JTF_DEPARTAMENTO_CONTRATADOActionPerformed
    ...
    private javax.swing.JTextField JTF_DEPARTAMENTO_CONTRATADO;
    ...
    private javax.swing.JTextField JTF_PROVINCIA_CONTRATADO;
